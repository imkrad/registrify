...
<body>
    ...
    <center style="margin-top: -10px; margin-bottom: 10px; font-size: 9px; border: 1px solid; text-transform: uppercase; color:#000; font-weight: bold; padding: 2px;">{{$data['student']['lastname']}}, {{$data['student']['firstname']}} {{$data['student']['middlename'][0]}}.</center>
