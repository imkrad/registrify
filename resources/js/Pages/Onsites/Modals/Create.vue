<template>
    <b-modal v-model="showModal" style="--vz-modal-width: 900px;" header-class="p-3 bg-light" :title="(!editable) ? 'Create Onsite Requests' : 'Edit Onsite Request'" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>
        <form class="customform">
            <BRow class="g-3">
                <BCol lg="12" class="mt-0 mb-n3"><hr class="text-muted"/></BCol>
                <BCol lg="12" style="margin-top: 13px; margin-bottom: -5px;">
                    <div class="row fs-11">
                        <BCol lg="6">Are you an Alumni ?</BCol>
                        <div class="col-md-3">
                            <div class="custom-control custom-radio mb-3">
                                <input type="radio" id="customRadio1" class="custom-control-input me-2" value="1" v-model="is_alumni">
                                <label class="custom-control-label fw-normal" for="customRadio1">Yes</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="custom-control custom-radio mb-3">
                                <input type="radio" id="customRadio1" class="custom-control-input me-2" value="0" v-model="is_alumni">
                                <label class="custom-control-label fw-normal" for="customRadio1">No </label>
                            </div>
                        </div>
                    </div>
                </BCol>               
                ...
                <BCol :lg="(is_alumni == 1) ? '12' : '6'" class="mt-1 mb-n2">
                ...
                <BCol lg="6" class="mt-1 mb-n2" >
                    <InputLabel for="name" value="Authorized Person" :message="form.errors.authorized"/>
                    <TextInput type="text" v-model="form.authorized" class="form-control" placeholder="Please enter authorized person" @input="handleInput('authorized')" :light="true"/>
                </BCol>
                ...
                <BCol lg="12" v-if="form.type_id">
                    <div class="primary-documents-grid fs-12">
